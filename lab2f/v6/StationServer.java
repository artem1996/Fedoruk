...
public class StationServer {
	...
	public static void main(String args[]) {
		try{
			...
			//Station ref1 = StationHelper.narrow(rootpoa.servant_to_reference(servant));
			...
			NameComponent nc = new NameComponent("BaseStation2", "");
			NameComponent path1[] = {nc};
			Station stationRef = StationHelper.narrow(ncRef.resolve(path1));
			//stationReference = stationRef;
			stationRef .registerStation(sref, "BaseStation");
